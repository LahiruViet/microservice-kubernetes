...
docker pull lahiruviet/api-gateway:latest
docker pull lahiruviet/product-service:latest
docker pull lahiruviet/order-service:latest
docker pull lahiruviet/inventory-service:latest
docker pull lahiruviet/notification-service:latest
...
kind load docker-image -n microservices lahiruviet/api-gateway:latest
kind load docker-image -n microservices lahiruviet/product-service:latest
kind load docker-image -n microservices lahiruviet/order-service:latest
kind load docker-image -n microservices lahiruviet/inventory-service:latest
kind load docker-image -n microservices lahiruviet/notification-service:latest